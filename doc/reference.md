...
|---|---|---:|---:|---:|
| VLM only | clean | 97 | 3 | 0 |
| VLM only | direct | 69 | 31 | 0 |
| VLM only | indirect | 84 | 16 | 0 |
| C5+C6A+C4+VLM | clean | 97 | 3 | 0 |
...
|---|---:|---:|---|
| `vlm_head_fallback` | 141 | 47.0% | C5/C6A 未命中且 C4 未早退的样本，进入 VLM fallback。 |
| `c4_early_exit` | 11 | 3.7% | 基于 VLM fallback 概率的 clean early-exit 统计；当前轻量顺序下它仍需要 VLM。 |
