...
def build_train_config(cfg: dict, out_dir_override: str | None,
    ...
    cfg_obj = TrainConfig(
        ...
        triplet_diagonal_weight=float(training.get("triplet_diagonal_weight", 0.0)),
        triplet_diagonal_margin=float(training.get("triplet_diagonal_margin", 0.0)),
        classification_mode=str(training.get("classification_mode", "flat")),
